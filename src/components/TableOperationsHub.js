...
import { 
  Grid, Plus, Search, Check, X, RefreshCw, Users, CreditCard, 
  DollarSign, Receipt, Clock, Sparkles, ChefHat, Trash2, Edit3, 
  QrCode, ExternalLink, Printer, CheckCircle2, AlertTriangle, 
  ArrowUpRight, Smartphone, Zap, Coffee, ChevronRight, Layers,
  ShoppingBag, ShieldCheck, Download
} from 'lucide-react';
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem', borderBottom: '1px solid #f1f5f9', paddingBottom: '0.75rem' }}>
                <div>
                  <h3 style={{ fontSize: '1.25rem', fontWeight: 900, color: '#0f172a', margin: 0 }}>
                    Settle Bill • Table {selectedTableForPayment.table.tableNumber}
                  </h3>
                  <span style={{ fontSize: '12px', color: '#64748b' }}>
                    Order #{selectedTableForPayment.activeOrder?.orderNumber || selectedTableForPayment.activeOrder?._id?.slice(-5)}
                  </span>
                </div>
                <button
                  type="button"
              ...
              <div style={{ marginBottom: '1.25rem' }}>
                ...
                <div style={{ marginTop: '8px', border: '1px solid #f1f5f9', borderRadius: '12px', overflow: 'hidden' }}>
                  {(selectedTableForPayment.activeOrder?.items || []).map((it, idx) => (
                    <div
                      key={idx}
                      style={{
                        display: 'flex',
                        ...
                        borderBottom: idx === (selectedTableForPayment.activeOrder?.items?.length - 1) ? 'none' : '1px solid #f1f5f9'
                      }}
                    >
                      <div>
                        ...
                        <span style={{ fontSize: '11px', color: '#64748b' }}>
                          {it.quantity || 1} × ₹{Number(it.price || it.item?.price || 0)}
                        </span>
                      </div>
                  ...
                  {[
                    ...
                    <button
                      ...
                      style={{
                        padding: '10px 4px',
                        borderRadius: '10px',
                        border: paymentMethod === m.id ? '2px solid #4f46e5' : '1px solid #cbd5e1',
                        background: paymentMethod === m.id ? '#eef2ff' : '#ffffff',
                        color: paymentMethod === m.id ? '#4f46e5' : '#334155',
                        fontWeight: 800,
                        fontSize: '12px',
                        cursor: 'pointer'
                      }}
              ...
              {(() => {
                ...
                return (
                  <div style={{
                    ...
                    {discount > 0 && (
                      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', color: '#ef4444', marginBottom: 4 }}>
                        <span>Discount</span>
                        <span>- ₹{discount}</span>
                      </div>
                    )}
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '16px', fontWeight: 900, color: '#0f172a', borderTop: '1px solid #e2e8f0', paddingTop: 6 }}>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                >
                  {isSubmitting ? 'Settling...' : '✓ Confirm Settle & Free Table'}
                </button>
              </div>
            </motion.div>
          </div>
