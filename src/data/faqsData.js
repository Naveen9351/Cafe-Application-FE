export const FAQS = [
  ...
  },
  {
    ...
    question: "How fast do tickets appear in the kitchen?",
    answer: "Under 50 milliseconds. The moment a diner or server taps 'Place Order', WebSocket channels instantly dispatch the order directly to the designated station screens (Grill, Bar, Fryer, Bakery, Expo)."
  },
  {
    category: "Payments",
